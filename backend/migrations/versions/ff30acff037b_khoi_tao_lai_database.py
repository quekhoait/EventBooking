...
Revision ID: ff30acff037b
Revises: 
Create Date: 2026-08-07 16:14:24.202761
...
def upgrade():
    ...
    sa.Column('role', sa.Enum('ADMIN', 'USER', 'STAFF', name='roleenum'), nullable=True),
    ...
    sa.ForeignKeyConstraint(['event_id'], ['event.id'], ),
    sa.ForeignKeyConstraint(['seat_id'], ['event_seat.id'], ),
    sa.ForeignKeyConstraint(['ticket_type_id'], ['event_ticket_type.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
