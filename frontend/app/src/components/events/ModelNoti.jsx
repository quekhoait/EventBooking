export default function NotificationModal({ isOpen, onClose, notifications = [], onSelectNotification }) {
                ...
                {notifications.length ? (
                    notifications.map((notification, index) => (
                        <div
                            ...
                            onClick={() => onSelectNotification && onSelectNotification(notification)}
                            className={`border-b border-[#f0d4c0] px-4 py-3 last:border-b-0 cursor-pointer transition-colors hover:bg-[#ffe6d2] ${
